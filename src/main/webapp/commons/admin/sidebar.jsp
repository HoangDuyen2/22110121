...
<div class="sidebar" id="sidebar">
  <div class="sidebar-inner slimscroll">
    <div id="sidebar-menu" class="sidebar-menu">
      <ul>
        <li class="active">
          <a href="${pageContext.request.contextPath}/admin/home"><img src="assets/img/icons/dashboard.svg" alt="img"><span> Dashboard</span> </a>
        </li>
        <li class="submenu">
          <a href="javascript:void(0);"><img src="assets/img/icons/product.svg" alt="img"><span> Product</span> <span class="menu-arrow"></span></a>
          <ul>
            <li><a href="${pageContext.request.contextPath}/admin/users">User List</a></li>
            <li><a href="${pageContext.request.contextPath}/admin/user-add">Add User</a></li>
            <li><a href="${pageContext.request.contextPath}/admin/books">Book List</a></li>
            <li><a href="${pageContext.request.contextPath}/admin/book-add">Add Book</a></li>
            <li><a href="${pageContext.request.contextPath}/admin/authors">Author List</a></li>
            <li><a href="${pageContext.request.contextPath}/admin/author-add">Add Author</a></li>
          </ul>
        </li>
        <li class="submenu">
