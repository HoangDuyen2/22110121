    ...
    <div class="row align-items-center">
      ...
      <div class="col-xl-6 col-lg-4 col-sm-6">
        <div class="singin-header-btn">
          <p>Already a member? <a href="${pageContext.request.contextPath}/login" class="sign-in-btn">Sign In</a></p>
        </div>
      </div>
    </div>
  </div>
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Oct 2024 00:33:30 GMT -->
</html>
